var/list/destructibles = list(/obj/structure/window,/obj/machinery/door/window,/obj/structure/closet,/obj/structure/table,/obj/structure/grille,/obj/structure/rack,/obj/structure/girder,/obj/machinery/hydroponics)
...
/mob/living/simple_animal/proc/get_lying_angle()
	. = lying_current
