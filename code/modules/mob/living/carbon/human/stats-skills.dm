...
//IB 2.0, сделано для фикса mood и будущей фичи со статами | ChillRaccoon
...
*/	//crit shit
	var/crit_success_chance = CRIT_SUCCESS_NORM             //Убрать коммент если пройдёт голос по статам
...
/mob/proc/get_success_chance()
	return crit_mood_modifier
                                       //Если пройдётся голосвание по статам, добавить -  crit_failure_chance + crit_failure_modifier + в каждую строку перед crit_mood_modifier
