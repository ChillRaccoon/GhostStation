...
/mob/proc/show_inv(mob/user as mob)
	...
	<BR><B>Back:</B> <A href='?src=\ref[src];item=back'>[(back ? back : "Nothing")]</A> [((istype(wear_mask, /obj/item/clothing/mask) && istype(back, /obj/item/weapon/tank) && !( internals )) ? text(" <A href='?src=\ref[];item=internal'>Set Internal</A>", src) : "")]
	<BR>[(internals ? text("<A href='?src=\ref[src];item=internals'>Remove Internals</A>") : "")]
