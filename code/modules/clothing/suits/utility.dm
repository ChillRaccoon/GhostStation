...
/obj/item/clothing/head/bomb_hood
	...
	armor = list(melee = 0, bullet = 0, laser = 0,energy = 0, bomb = 100, bio = 0, rad = 0, telepathy = 10)
...
/obj/item/clothing/head/radiation
	...
	flags = HEADCOVERSEYES|HEADCOVERSMOUTH|BLOCKHAIR
	body_parts_covered = HEAD|FACE|EYES
	armor = list(melee = 0, bullet = 0, laser = 0,energy = 0, bomb = 0, bio = 60, rad = 100, telepathy = 0)
