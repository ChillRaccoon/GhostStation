//OLD SHIT, customize by ChillRaccoon | LF Ficha
//---------------------------------------
mob/proc/flash_weakest_pain()
	flick("weakest_pain",pain)

//mob/proc/flash_weak_pain()               Не требуется из-за дубликата дефайна - code\modules\organs\pain.dm:6
